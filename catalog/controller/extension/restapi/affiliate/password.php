...
class ControllerAffiliatePassword extends Controller {
	...
	public function index() {
		if (!$this->affiliate->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('extension/restapi/affiliate/password', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/affiliate/password', '', true)
		);
		...
		$data['action'] = $this->url->link('extension/restapi/affiliate/password', '', true);
		...
		$data['back'] = $this->url->link('extension/restapi/affiliate/account', '', true);
