...
class ControllerAffiliatePayment extends Controller {
	...
	public function index() {
		if (!$this->affiliate->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('extension/restapi/affiliate/payment', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/affiliate/payment', '', true)
		);
		...
		$data['action'] = $this->url->link('extension/restapi/affiliate/payment', '', true);
