...
class ControllerAffiliateEdit extends Controller {
	...
	public function index() {
		if (!$this->affiliate->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('extension/restapi/affiliate/edit', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/affiliate/edit', '', true)
		);
		...
		$data['action'] = $this->url->link('extension/restapi/affiliate/edit', '', true);
