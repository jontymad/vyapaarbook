...
class ControllerAffiliateRegister extends Controller {
	...
	public function index() {
		if ($this->affiliate->isLogged()) {
			$this->response->redirect($this->url->link('extension/restapi/affiliate/account', '', true));
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/restapi/affiliate/success'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/affiliate/register', '', true)
		);
		...
		$data['text_account_already'] = sprintf($this->language->get('text_account_already'), $this->url->link('extension/restapi/affiliate/login', '', true));
		...
		$data['action'] = $this->url->link('extension/restapi/affiliate/register', '', true);
		...
		if ($this->config->get('config_affiliate_id')) {
			...
			if ($information_info) {
				$data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('extension/restapi/information/information/agree', 'information_id=' . $this->config->get('config_affiliate_id'), true), $information_info['title'], $information_info['title']);
			} else {
				$data['text_agree'] = '';
			}
		} else {
