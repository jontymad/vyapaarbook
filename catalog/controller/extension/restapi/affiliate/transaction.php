...
class ControllerAffiliateTransaction extends Controller {
	public function index() {
		if (!$this->affiliate->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('extension/restapi/affiliate/transaction', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/affiliate/transaction', '', true)
		);
		...
		$pagination->limit = 10;
		$pagination->url = $this->url->link('extension/restapi/affiliate/transaction', 'page={page}', true);
