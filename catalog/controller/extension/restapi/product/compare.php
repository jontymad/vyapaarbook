<?php
class ControllerExtensionRestapiProductCompare extends Controller {
	public function index() {
		...
		if (isset($this->request->get['remove'])) {
			...
			$this->response->redirect($this->url->link('extension/restapi/product/compare'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/product/compare')
		);
		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			if ($product_info) {
				...
				$data['products'][$product_id] = array(
					...
					'href'         => $this->url->link('extension/restapi/product/product', 'product_id=' . $product_id),
					'remove'       => $this->url->link('extension/restapi/product/compare', 'remove=' . $product_id)
				);
	...
	public function add() {
		...
		if ($product_info) {
			...
			$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('extension/restapi/product/product', 'product_id=' . $this->request->post['product_id']), $product_info['name'], $this->url->link('extension/restapi/product/compare'));
