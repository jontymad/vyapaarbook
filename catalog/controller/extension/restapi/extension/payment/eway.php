<?php
class ControllerExtensionRestapiExtensionPaymentEway extends Controller {
	public function index() {
		...
		$request->RedirectUrl = $this->url->link('extension/restapi/extension/payment/eway/callback', '', true);
		...
		if (isset($lbl_error)) {
			...
			if ($this->config->get('payment_eway_paymode') == 'iframe') {
				$data['callback'] = $this->url->link('extension/restapi/extension/payment/eway/callback', 'AccessCode=' . $result->AccessCode, true);
