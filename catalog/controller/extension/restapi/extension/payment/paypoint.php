<?php
class ControllerExtensionRestapiExtensionPaymentPaypoint extends Controller {
	public function index() {
		...
		$data['callback'] = $this->url->link('extension/restapi/extension/payment/paypoint/callback', '', true);
	...
	public function callback() {
		...
		if ($order_info) {
			...
			$data['text_success_wait'] = sprintf($this->language->get('text_success_wait'), $this->url->link('extension/restapi/checkout/success'));
			$data['text_failure_wait'] = sprintf($this->language->get('text_failure_wait'), $this->url->link('extension/restapi/checkout/cart'));
			...
			if (isset($this->request->get['code']) && $this->request->get['code'] == 'A' && $status) {
				...
				$data['continue'] = $this->url->link('extension/restapi/checkout/success');
