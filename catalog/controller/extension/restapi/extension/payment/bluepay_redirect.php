<?php
class ControllerExtensionRestapiExtensionPaymentBluePayRedirect extends Controller {
	...
	public function send() {
		...
		$post_data['APPROVED_URL'] = $this->url->link('extension/restapi/extension/payment/bluepay_redirect/callback', '', true);
		$post_data['DECLINED_URL'] = $this->url->link('extension/restapi/extension/payment/bluepay_redirect/callback', '', true);
		$post_data['MISSING_URL'] = $this->url->link('extension/restapi/extension/payment/bluepay_redirect/callback', '', true);
