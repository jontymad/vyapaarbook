<?php
class ControllerExtensionRestapiExtensionPaymentFirstdata extends Controller {
	public function index() {
		...
		$data['url_success'] = $this->url->link('extension/restapi/checkout/success', '', true);
		$data['url_fail'] = $this->url->link('extension/restapi/extension/payment/firstdata/fail', '', true);
		$data['url_notify'] = $this->url->link('extension/restapi/extension/payment/firstdata/notify', '', true);
