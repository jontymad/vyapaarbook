<?php
class ControllerExtensionRestapiExtensionPaymentPilibaba extends Controller {
	public function index() {
		...
		$data['pageUrl']      = $this->url->link('extension/restapi/checkout/checkout', '', true);
		$data['serverUrl']    = $this->url->link('extension/restapi/extension/payment/pilibaba/callback', '', true);
		$data['redirectUrl']  = $this->url->link('extension/restapi/checkout/success', '', true);
		...
		foreach ($this->cart->getProducts() as $product) {
			...
			$products[] = array_map('strval', array(
				...
				'productUrl' => str_replace('&amp;', '&', $this->url->link('extension/restapi/product/product', 'product_id=' . $product['product_id'])),
