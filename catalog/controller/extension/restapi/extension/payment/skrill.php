<?php
class ControllerExtensionRestapiExtensionPaymentSkrill extends Controller {
	public function index() {
		...
		$data['return_url'] = $this->url->link('extension/restapi/checkout/success');
		$data['cancel_url'] = $this->url->link('extension/restapi/checkout/checkout', '', true);
		$data['status_url'] = $this->url->link('extension/restapi/extension/payment/skrill/callback');
