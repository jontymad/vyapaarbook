<?php
class ControllerExtensionRestapiExtensionPaymentSagepayDirect extends Controller {
	...
	public function send() {
		...
		if ($response_data['Status'] == '3DAUTH') {
			...
			$json['TermUrl'] = $this->url->link('extension/restapi/extension/payment/sagepay_direct/callback', '', true);
			...
			$json['redirect'] = $this->url->link('extension/restapi/checkout/success', '', true);
		} else {
