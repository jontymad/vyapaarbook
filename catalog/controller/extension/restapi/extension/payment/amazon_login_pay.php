<?php
class ControllerExtensionRestapiExtensionPaymentAmazonLoginPay extends Controller {
	public function address() {
		...
		if (!isset($this->request->cookie['amazon_Login_state_cache'])) {
			...
			$this->response->redirect($this->url->link('extension/restapi/extension/payment/amazon_login_pay/failure', '', true));
		}
		...
		$data['shipping_quotes'] = $this->url->link('extension/restapi/extension/payment/amazon_login_pay/shippingquotes', '', true);
		$data['payment_method'] = $this->url->link('extension/restapi/extension/payment/amazon_login_pay/paymentmethod', '', true);

		$data['cart'] = $this->url->link('extension/restapi/checkout/cart');
	...
	public function paymentMethod() {
		...
		$data['confirm_order'] = $this->url->link('extension/restapi/extension/payment/amazon_login_pay/confirm', '', true);
		...
		$data['continue'] = $this->url->link('extension/restapi/extension/payment/amazon_login_pay/confirm', '', true);
		$data['back'] = $this->url->link('extension/restapi/extension/payment/amazon_login_pay/address', '', true);
	...
	public function confirm() {
		...
		if (!isset($this->request->cookie['amazon_Login_state_cache'])) {
			$this->session->data['lpa']['error'] = $this->language->get('error_login');
			$this->response->redirect($this->url->link('extension/restapi/extension/payment/amazon_login_pay/loginFailure', '', true));
		}
		...
		if (!isset($this->session->data['lpa']['shipping_method']) || !isset($this->session->data['lpa']['address'])) {
			$this->response->redirect($this->url->link('extension/restapi/extension/payment/amazon_login_pay/address', '', true));
		}
		...
		$data['merchant_id'] = $this->config->get('payment_amazon_login_pay_merchant_id');
		$data['process_order'] = $this->url->link('extension/restapi/extension/payment/amazon_login_pay/processorder', '', true);
		...
		$data['back'] = $this->url->link('extension/restapi/extension/payment/amazon_login_pay/paymentMethod', '', true);
	...
	public function processOrder() {
		...
		if (!isset($this->session->data['order_id'])) {
			$this->response->redirect($this->url->link('extension/restapi/common/home'));
		}
		...
		if (isset($response['redirect'])) {
			...
			$this->response->redirect($this->url->link('extension/restapi/extension/payment/amazon_login_pay/' . $response['redirect'], '', true));
		}
		...
		if ($response['status'] == 'Closed' || $response['status'] == 'Open') {
			...
			$this->response->redirect($this->url->link('extension/restapi/extension/payment/amazon_login_pay/success', '', true));
		} else {
			$this->failure($this->language->get('error_process_order'));
		}
	}
	...
	public function success() {
		unset($this->session->data['lpa']);
		$this->response->redirect($this->url->link('extension/restapi/checkout/success', '', true));
	}

	public function failure($error) {
		unset($this->session->data['lpa']);
		$this->session->data['error'] = $error;
		$this->response->redirect($this->url->link('extension/restapi/checkout/cart', '', true));
	}
	...
	public function setShipping() {
		...
		if (isset($this->request->post['shipping_method'])) {
			...
			$json['redirect'] = $this->url->link('extension/restapi/extension/payment/amazon_login_pay/paymentMethod', '', true);
		} else {
			$json['redirect'] = $this->url->link('extension/restapi/extension/payment/amazon_login_pay/paymentMethod', '', true);
		}
