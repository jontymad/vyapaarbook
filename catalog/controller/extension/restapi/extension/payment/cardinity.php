<?php
class ControllerExtensionRestapiExtensionPaymentCardinity extends Controller {
				...
				if (!in_array($payment->getStatus(), $successful_order_statuses)) {
					...
					if ($payment->getStatus() == 'pending') {
						...
						$json['3ds'] = array(
							...
							'TermUrl' => $this->url->link('extension/restapi/extension/payment/cardinity/threeDSecureCallback', '', true),
							'hash'    => $hash
						);
