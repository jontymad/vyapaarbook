<?php
class ControllerExtensionRestapiExtensionPaymentLaybuy extends Controller {
	public function index() {
		...
		$data['action'] = $this->url->link('extension/restapi/extension/payment/laybuy/postToLaybuy', '', true);
	...
	public function postToLaybuy()	{
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST') {
			...
			if ($order_info) {
				...
				$data['RETURNURL']    = $this->url->link('extension/restapi/extension/payment/laybuy/callback', '', true);
				$data['CANCELURL']    = $this->url->link('extension/restapi/extension/payment/laybuy/cancel', '', true);
