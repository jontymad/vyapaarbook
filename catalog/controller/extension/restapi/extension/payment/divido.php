<?php
class ControllerExtensionRestapiExtensionPaymentDivido extends Controller {
	const
	...
	public function confirm() {
		...
		$callback_url = $this->url->link('extension/restapi/extension/payment/divido/update', '', true);
		$return_url = $this->url->link('extension/restapi/checkout/success', '', true);
		$checkout_url = $this->url->link('extension/restapi/checkout/checkout', '', true);
