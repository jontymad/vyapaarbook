<?php
class ControllerExtensionRestapiExtensionPaymentSagepayServer extends Controller {
	public function index() {
		...
		$data['action'] = $this->url->link('extension/restapi/extension/payment/sagepay_server/send', '', true);
	...
	public function send() {
		...
		$payment_data['NotificationURL'] = $this->url->link('extension/restapi/extension/payment/sagepay_server/callback', '', true);
	...
	public function callback() {
		...
		$success_page = $this->url->link('extension/restapi/extension/payment/sagepay_server/success', '', true);
		$error_page = $this->url->link('extension/restapi/extension/payment/sagepay_server/failure', '', true);
