...
class ControllerExtensionRestapiExtensionPaymentNochex extends Controller {
	public function index() {
		...
		$data['success_url'] = $this->url->link('extension/restapi/checkout/success', '', true);
		$data['cancel_url'] = $this->url->link('extension/restapi/checkout/payment', '', true);
		$data['declined_url'] = $this->url->link('extension/restapi/extension/payment/nochex/callback', 'method=decline', true);
		$data['callback_url'] = $this->url->link('extension/restapi/extension/payment/nochex/callback', 'order=' . $this->session->data['order_id'], true);
