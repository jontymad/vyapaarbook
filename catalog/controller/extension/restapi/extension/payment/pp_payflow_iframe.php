<?php
class ControllerExtensionRestapiExtensionPaymentPPPayflowIframe extends Controller {
	...
	public function paymentReturn() {
		$data['url'] = $this->url->link('extension/restapi/checkout/success');

		$this->response->setOutput($this->load->view('extension/payment/pp_payflow_iframe_return', $data));
	}

	public function paymentCancel() {
		$data['url'] = $this->url->link('extension/restapi/checkout/checkout');
