...
class ControllerExtensionRestapiExtensionPaymentRazorpay extends Controller
{
    /**
     * Event constants
     */
    ...
    public function index()
    {
        ...
        {
            $response['pageContent'] = $this->load->view($this->config->get('config_template').'/template/extension/payment/razorpay', $data);
        } 
        else 
        {
            $response['pageContent'] = $this->load->view('extension/payment/razorpay', $data);
        }
