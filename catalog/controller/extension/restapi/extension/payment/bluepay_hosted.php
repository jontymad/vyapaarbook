<?php
class ControllerExtensionRestapiExtensionPaymentBluePayHosted extends Controller {
	public function index() {
		...
		$data['APPROVED_URL'] = $this->url->link('extension/restapi/extension/payment/bluepay_hosted/callback', '', true);
		$data['DECLINED_URL'] = $this->url->link('extension/restapi/extension/payment/bluepay_hosted/callback', '', true);
		$data['MISSING_URL'] = $this->url->link('extension/restapi/extension/payment/bluepay_hosted/callback', '', true);
		$data['REDIRECT_URL'] = $this->url->link('extension/restapi/extension/payment/bluepay_hosted/callback', '', true);
	...
	public function callback() {
		...
		if (isset($this->session->data['order_id'])) {
			...
			$this->response->redirect($this->url->link('extension/restapi/account/login', '', true));
		}
	}
