<?php
class ControllerExtensionRestapiExtensionPaymentPumbolt extends Controller {
	...
	public function index()
	{
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . 'extension/payment/pumbolt_payu')) {
			$response['pageContent'] = $this->load->view($this->config->get('config_template') . 'extension/payment/pumbolt_payu', $data);	
		} else {
			$response['pageContent'] = $this->load->view('extension/payment/pumbolt_payu', $data);
		}
