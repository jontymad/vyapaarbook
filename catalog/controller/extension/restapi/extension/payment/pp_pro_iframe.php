<?php
class ControllerExtensionRestapiExtensionPaymentPPProIframe extends Controller {
	...
	private function constructButtonData($order_info) {
		...
		$s_data['L_BUTTONVAR20'] = 'notify_url=' . $this->url->link('extension/restapi/extension/payment/pp_pro_iframe/notify', '', true);
		$s_data['L_BUTTONVAR21'] = 'cancel_return=' . $this->url->link('extension/restapi/checkout/checkout', '', true);
		...
		$s_data['L_BUTTONVAR56'] = 'return=' . $this->url->link('extension/restapi/checkout/success', '', true);
