<?php
class ControllerExtensionRestapiExtensionPaymentWorldpay extends Controller {
	public function index() {
		...
		$data['form_submit'] = $this->url->link('extension/restapi/extension/payment/worldpay/send', '', true);
