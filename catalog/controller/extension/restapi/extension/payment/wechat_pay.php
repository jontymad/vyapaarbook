...
class ControllerExtensionRestapiExtensionPaymentWechatPay extends Controller {
	public function index() {
		$data['button_confirm'] = $this->language->get('button_confirm');

		$data['redirect'] = $this->url->link('extension/restapi/extension/payment/wechat_pay/qrcode');
	...
	public function qrcode() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/extension/payment/wechat_pay/qrcode')
		);
		...
		$notify_url = HTTPS_SERVER . "payment_callback/wechat_pay"; //$this->url->link('extension/restapi/wechat_pay/callback');
		...
		$data['action_success'] = $this->url->link('extension/restapi/checkout/success');
