<?php
class ControllerExtensionRestapiExtensionPaymentLiqPay extends Controller {
	public function index() {
		...
		$xml .= '	<result_url>' . $this->url->link('extension/restapi/checkout/success', '', true) . '</result_url>';
		$xml .= '	<server_url>' . $this->url->link('extension/restapi/extension/payment/liqpay/callback', '', true) . '</server_url>';
