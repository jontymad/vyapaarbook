<?php
class ControllerExtensionRestapiModuleSagepayDirectCards extends Controller {
	public function index() {
		if ($this->config->get('sagepay_direct_cards_status') && $this->config->get('sagepay_direct_status') && $this->customer->isLogged()) {
			...
			$data['card'] = $this->url->link('extension/restapi/account/sagepay_direct_cards', '', true);
