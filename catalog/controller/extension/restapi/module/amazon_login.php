<?php
class ControllerExtensionRestapiModuleAmazonLogin extends Controller {
	public function index() {
		...
		if ($this->config->get('amazon_login_pay_status') && $this->config->get('amazon_login_status') && !$this->customer->isLogged() && !empty($this->request->server['HTTPS'])) {
			...
			$data['amazon_login_return_url'] = $this->url->link('extension/restapi/module/amazon_login/login', '', true);
