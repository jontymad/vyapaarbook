<?php
class ControllerExtensionRestapiModuleSagepayServerCards extends Controller {
	public function index() {
		if ($this->config->get('sagepay_server_cards_status') && $this->config->get('sagepay_server_status') && $this->customer->isLogged()) {
			...
			$data['card'] = $this->url->link('extension/restapi/account/sagepay_server_cards', '', true);
