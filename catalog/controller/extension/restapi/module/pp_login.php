<?php
class ControllerExtensionRestapiModulePPLogin extends Controller {
	private $error = array();

	public function index() {
		if (!$this->customer->isLogged()) {
			$data['client_id'] = $this->config->get('pp_login_client_id');
			$data['return_url'] = $this->url->link('extension/restapi/module/pp_login/login', '', true);
	...
	public function login() {
		...
		if ($this->customer->isLogged()) {
			echo '<script type="text/javascript">window.opener.location = "' . $this->url->link('extension/restapi/account/account', '', true) . '"; window.close();</script>';
		}
		...
		if (!isset($this->request->get['code'])) {
			...
			echo '<script type="text/javascript">window.opener.location = "' . $this->url->link('extension/restapi/account/login', '', true) . '"; window.close();</script>';
		} else {
