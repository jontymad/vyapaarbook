<?php
class ControllerExtensionRestapiInformationContact extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/restapi/information/contact/success'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/information/contact')
		);
		...
		$data['action'] = $this->url->link('extension/restapi/information/contact', '', true);
