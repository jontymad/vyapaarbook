...
class ControllerCreditCardSagepayDirect extends Controller {
	public function index() {
		...
		if ($this->config->get('sagepay_direct_card')) {
			...
			$data['delete'] = $this->url->link('extension/restapi/credit_card/sagepay_direct/delete', 'card_id=', true);
			...
			$pagination->limit = 10;
			$pagination->url = $this->url->link('extension/restapi/credit_card/sagepay_direct', 'page={page}', true);
		...
		$data['add'] = $this->url->link('extension/restapi/credit_card/sagepay_direct/add', '', true);
	...
	public function add() {
		...
		$data['back'] = $this->url->link('extension/restapi/credit_card/sagepay_direct', '', true);
		$data['add'] = $this->url->link('extension/restapi/credit_card/sagepay_direct/addCard', '', true);
	...
	public function delete() {
		...
		$this->response->redirect($this->url->link('extension/restapi/acredit_card/sagepay_direct', '', true));
	}
	...
	public function addCard() {
		...
		$this->response->redirect($this->url->link('extension/restapi/credit_card/sagepay_direct', '', true));
	}
}
