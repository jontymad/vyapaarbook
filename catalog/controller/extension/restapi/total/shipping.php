<?php
class ControllerExtensionRestapiTotalShipping extends Controller {
	...
	public function quote() {
		...
		if (!$this->cart->hasShipping()) {
			$json['error']['warning'] = sprintf($this->language->get('error_no_shipping'), $this->url->link('extension/restapi/information/contact'));
		}
