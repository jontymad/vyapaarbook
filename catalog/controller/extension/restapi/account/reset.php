<?php
class ControllerExtensionRestapiAccountReset extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($customer_info) {
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/restapi/account/reset', '', true)
			);
			...
			$data['action'] = $this->url->link('extension/restapi/account/reset', 'code=' . $code, true);

			$data['back'] = $this->url->link('extension/restapi/account/login', '', true);
