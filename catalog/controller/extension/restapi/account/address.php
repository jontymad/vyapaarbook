<?php
class ControllerExtensionRestapiAccountAddress extends Controller {
	private $error = array();
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			return new Action('extension/restapi/account/address');
		}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['address_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/restapi/account/address/add', '', true)
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_address_edit'),
				'href' => $this->url->link('extension/restapi/account/address/edit', 'address_id=' . $this->request->get['address_id'], true)
			);
		}
		...
		if (!isset($this->request->get['address_id'])) {
			$data['action'] = $this->url->link('extension/restapi/account/address/add', '', true);
		} else {
			$data['action'] = $this->url->link('extension/restapi/account/address/edit', 'address_id=' . $this->request->get['address_id'], true);
		}
		...
		$data['back'] = $this->url->link('extension/restapi/account/address', '', true);
