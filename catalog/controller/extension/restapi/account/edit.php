<?php
class ControllerExtensionRestapiAccountEdit extends Controller {
	private $error = array();

	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('extension/restapi/account/edit', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/restapi/account/edit', '', true)
		);
		...
		$data['action'] = $this->url->link('extension/restapi/account/edit', '', true);
