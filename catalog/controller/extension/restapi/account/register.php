...
$data = array(
	...
	'text_account_already' => $this->language->get('text_account_already'),
	'text_newsletter' => $this->language->get('text_newsletter'),
	'text_your_password' => $this->language->get('text_your_password'),
	...
	'entry_newsletter' => $this->language->get('entry_newsletter'),
...
$data['success'] = true;
		...
		if ($this->config->get('config_account_id')) {
			...
			if ($information_info) {
				...
				//$data['text_agree'] = str_replace('<a',"<span",$data['text_agree']);
				//$data['text_agree'] = str_replace('a>',"span>",$data['text_agree']);

$data['agree_information'] = array(
	'id' => $this->config->get('config_account_id'),
	'title' => $information_info['title'],
	'href'  => $this->url->link('extension/restapi/information/information/agree', 'information_id=' . $this->config->get('config_account_id'), true)
);
