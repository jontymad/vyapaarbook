<?php
class ControllerExtensionRestapiAccountTransaction extends Controller {
	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('extension/restapi/account/transaction', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/account/transaction', '', true)
		);
		...
		$pagination->limit = 10;
		$pagination->url = $this->url->link('extension/restapi/account/transaction', 'page={page}', true);
