<?php
class ControllerExtensionRestapiAccountRecurring extends Controller {
	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('extension/restapi/account/recurring', '', true);

			return new Action('extension/restapi/affiliate/login');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/account/recurring', $url, true)
		);
		...
		foreach ($results as $result) {
			...
			$data['recurrings'][] = array(
				...
				'view'               => $this->url->link('extension/restapi/account/recurring/info', 'order_recurring_id=' . $result['order_recurring_id'], true),
			);
		}
		...
		$pagination->url = $this->url->link('extension/restapi/account/recurring', 'page={page}', true);
	...
	public function info() {
		...
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('extension/restapi/account/recurring/info', 'order_recurring_id=' . $order_recurring_id, true);
		...
		if ($recurring_info) {
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/restapi/account/recurring/info', 'order_recurring_id=' . $this->request->get['order_recurring_id'] . $url, true),
			);
			...
			$data['order'] = $this->url->link('extension/restapi/account/order/info', 'order_id=' . $recurring_info['order_id'], true);
			$data['product'] = $this->url->link('extension/restapi/product/product', 'product_id=' . $recurring_info['product_id'], true);
			...
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/restapi/account/recurring', '', true)
			);

			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_recurring'),
				'href' => $this->url->link('extension/restapi/account/recurring/info', 'order_recurring_id=' . $order_recurring_id, true)
			);

			$data['continue'] = $this->url->link('extension/restapi/account/recurring', '', true);
