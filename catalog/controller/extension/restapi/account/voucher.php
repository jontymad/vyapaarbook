<?php
class ControllerExtensionRestapiAccountVoucher extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			return new Action('extension/restapi/account/voucher/success');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/account/voucher', '', true)
		);
		...
		$data['action'] = $this->url->link('extension/restapi/account/voucher', '', true);
	...
	public function success() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/restapi/account/voucher')
		);
