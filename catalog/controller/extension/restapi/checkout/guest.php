<?php
class ControllerExtensionRestapiCheckoutGuest extends Controller {
...
if($this->customer->isLogged()) {
	if (isset($this->session->data['payment_address']['customer_group_id'])) {
	...
	if (isset($this->session->data['guest']['customer_group_id'])) {
		...
		if (isset($this->session->data['guest']['shipping_address'])) {
			$data['shipping_address'] = $this->session->data['guest']['shipping_address'] == true ? true : false;
		} else {
